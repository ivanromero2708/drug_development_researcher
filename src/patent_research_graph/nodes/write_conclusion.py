...
class WriteConclusion:
    ...
    def write_conclusion(self, state: PatentResearchGraphState, config: RunnableConfig):
        ...
        return {"patent_research_report_conclusion": conclusion.content}
    
    def run(self, state: PatentResearchGraphState, config: RunnableConfig):
        return self.write_conclusion(state, config)
