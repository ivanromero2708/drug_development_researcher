...
from ...state import DocumentClusters
from ..prompts import PROMPT_CLUSTER_RELATED_DOCS
...
class ClusterRelatedDocs:
    ...
    async def cluster(self, state: LiteratureResearchGraphState, config: RunnableConfig) -> Dict[str, Any]:
        """
        ...
        system_msg = SystemMessage(content="You are an expert in pharmaceutical literature analysis.")
    ...
    async def check_property_clusters(self, state: LiteratureResearchGraphState, config: RunnableConfig) -> Dict[str, Any]:
